...
export class PlaygroundComponent implements OnInit, AfterViewInit {
  private examples: any = {
    ...
    exampleList: {
      'asf': [
        ...
        'asf-titlemap-examples', 'asf-kitchen-sink', 'asf-hack-conditional-required', 'asf-allof', 'asf-anyof', 'asf-multilang', 'asf-work',
      ],
      'rjsf': [
    ...
    examples: {
      'asf': {
        ...
        'asf-anyof': 'AnyOf (selected subform)',
  ...
  private loadSelectedExample(selectedSet?: string, selectedExample?: string) {
    ...
    this.http
      .get('src/playground/examples/' + this.selectedExample + '.json')
